...
const storeUserDetailsReducer = (state, action) => {
    return updateObject(state, {
      user: action.user,  // Store the user details in the state
    });
};
...
const Reducer = (state=initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.STORE_USER_DETAILS: return storeUserDetailsReducer(state, action);
        default:
            return state;
    }
}
